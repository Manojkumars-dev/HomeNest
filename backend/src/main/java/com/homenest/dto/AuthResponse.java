...
public class AuthResponse {
    ...
    public static class UserDto {
        ...
        public UserDto() {}
        public UserDto(Long id, String name, String email, String role, String phone) {
            this.id = id; this.name = name; this.email = email;
            this.role = role; this.phone = phone;
        }
        ...
        public static class UserDtoBuilder {
            ...
            private String role; private String phone;
            ...
            public UserDto build() { return new UserDto(id, name, email, role, phone); }
        }
    }
}
